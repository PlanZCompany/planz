...
type heading1Props = {
  ...
  fontStyle?:
    ...
    | "font-sansation font-normal italic"
...
const headingMap = {
  h1: "text-[36px] sm:text-[48px] md:text-[64px] xl:text-[72px] 2xl:text-[86px] leading-[120%]",
...
const GenericHeading = ({
  ...
  return (
    <div
      className={`${!customStyles && headingMap[headingType]} ${extraClass} ${
        fontStyle !== "custom" && fontStyle
      } ${textColor} ${align && align}`}
    >
      {children}
    </div>
  );
