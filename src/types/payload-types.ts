...
export interface Task {
  ...
  title: string;
  /**
   * Моля, придържайте се към конвенцията за задачите.
   */
  description: {
    root: {
      type: string;
  ...
  /**
   * Моля, бъдете ясни в описанието и часовете на работа.
   */
  estimate: {
    root: {
      type: string;
...
export interface Idea {
  id: number;
  /**
   * Моля, придържайте се към конвенцията за заглавия.
   */
  title: string;
  /**
